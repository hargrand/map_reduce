/**
 * @file mandel.cuh
 * @brief Defines the mandelbrot class for generating Mandelbrot set data using CUDA.
 */
...
/**
 * @class mandelbrot
 * @brief Represents the Mandelbrot set calculation logic for CUDA.
 ...
 *          by leveraging CUDA for parallel computation.
 */
class mandelbrot
{
private:
...
public:
    ...
    /**
     * @brief Generates the color data for the Mandelbrot set image using CUDA.
